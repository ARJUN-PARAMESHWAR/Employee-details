    ...
    <div className="cover">
        ...
        <div className="formContents">
            ...
            <div className="username">
                ...
                <input name="username" type="text" placeholder="Enter username" className="inputBar_LoginPage" id="input1" onChange={userDetails1} />
            </div>

            <div className="password">
                <span className="fa-solid fa-lock formicons"></span>
                <input name ="password" type="password" placeholder="Password" className="inputBar_LoginPage" id="input2"  onChange={userDetails2}/>
            </div>
